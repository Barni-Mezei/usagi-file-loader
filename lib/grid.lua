...
---@field set_cell function Sets the value of a cell in the grid
---@field get_cell function Returns with the value of a cell in the grid
---@field foreach  function Returns with the value of a cell in the grid
